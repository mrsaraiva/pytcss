...
import org.msaraiva.pytcss.metadata.generated.TcssAvailableProperties;
import org.msaraiva.pytcss.metadata.generated.TcssCssTypeUrls;
...
public final class TcssPropertyCatalog {
    ...
    private static void register(@NotNull Map<String, TcssPropertyInfo> map,
        ...
        // Generate property-specific documentation URL using relative path (includes subdirectories)
        String fileName = tcssNameToFileName(name);
        String relativePath = TcssAvailableProperties.getRelativePath(fileName);
        String propertyUrl = relativePath != null
                ? "https://textual.textualize.io/" + relativePath + "/"
                : null;
